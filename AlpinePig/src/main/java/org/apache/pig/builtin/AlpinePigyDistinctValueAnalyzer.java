...
public class AlpinePigyDistinctValueAnalyzer extends EvalFunc<Tuple> implements
		Algebraic, Accumulator<Tuple> {
	private static Log itsLogger = LogFactory.getLog(AlpinePigyDistinctValueAnalyzer.class );
