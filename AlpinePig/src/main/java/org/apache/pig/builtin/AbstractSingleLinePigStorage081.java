 ...
 *
 */
public abstract class AbstractSingleLinePigStorage081  extends AbstractPigStorage081  {
	private String headerLine = "" ;
	protected Tuple emptyTuple = mTupleFactory.newTuple() ;
	protected RecordParser recordParser;

			
	public AbstractSingleLinePigStorage081(String headerLine, String typeString,String callBackURL,String uuid,String operatorName,RecordParser recordParser){
