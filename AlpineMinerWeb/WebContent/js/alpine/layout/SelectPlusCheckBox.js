...
define([
    ...
    "dojo/i18n!dijit/form/nls/validate"
            ...
            _FormSelectWidget, _HasDropDown, Menu, MenuItem, CheckBox, MenuSeparator, Tooltip, template){
   /*=====
...
//		can take a <select> as its input.
    ...
    var _SelectMenuPlusCheckBox = declare("alpine.layout._SelectMenuPlusCheckBox", Menu, {
        // summary:
        ...
        buildRendering: function(){
            ...
            n.appendChild(o);
            var p = dojo.create("tr", null, o);
            var p11 = dojo.create("td", null, p);
            var p12 = dojo.create("td", null, p);
            var newId = this.id + "_cbox";
            var p2 = dojo.create("label", {innerHTML:alpine.nls.hadoop_enabled, "for":newId}, p12);
            domClass.add(p2, "dropdownCheckBox");
            cbox = new CheckBox({
                id: newId,
                checked: false
            }, dojo.create("div", null, p12));
        },
    ...
    var SelectPlusCheckBox = declare("alpine.layout.SelectPlusCheckBox", [_FormSelectWidget, _HasDropDown], {
        // summary:
        //		This is a "styleable" select box - it is basically a DropDownButton which
        //		can take a <select> as its input.
        ...
        _fillContent: function(){
            ...
            this.dropDown = new _SelectMenuPlusCheckBox({id: this.id + "_menu"});
        ...
        _setDisplay: function(/*String*/ newDisplay){
            ...
            var hdlbl = lbl;
            if (cbox.get('checked')==true) {
                hdlbl += " (" + alpine.nls.hadoop_enabled +")";
            }
            this.containerNode.innerHTML = '<span class="dijitReset dijitInline ' + this.baseClass + 'Label">' + hdlbl + '</span>';
        ...
        _onBlur: function(){
            Tooltip.hide(this.domNode);
            this.inherited(arguments);
            this._setDisplay(this.get('displayedValue'));
        }

    });

    SelectPlusCheckBox._Menu = _SelectMenuPlusCheckBox;	// for monkey patching
    return SelectPlusCheckBox;
});
