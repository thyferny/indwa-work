...
java -Xms256m -Xmx256m  -cp ./WebContent/js/util/buildscripts/../shrinksafe/js.jar;./WebContent/js/util/buildscripts/../closureCompiler/compiler.jar;./WebContent/js/util/buildscripts/../shrinksafe/shrinksafe.jar org.mozilla.javascript.tools.shell.Main  ./WebContent/js/util/buildscripts/../../dojo/dojo.js baseUrl=./WebContent/js/util/buildscripts/../../dojo load=build %*
