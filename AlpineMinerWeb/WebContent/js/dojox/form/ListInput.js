...
var _ListInputInputItem = declare("dojox.form._ListInputInputItem", [Widget, TemplatedMixin],
	...
	postCreate: function(){
		...
		this.closeButtonNode = domConstruct.create("span",{
			"class" : "dijitButtonNode listInputCloseIcon",
	...
	_onCloseEnter: function(){
		...
		// tags:
		//		private
		domClass.add(this.closeButtonNode, "listInputCloseIcon-hover");
	},
	...
	_onCloseLeave: function(){
		...
		// tags:
		//		private
		domClass.remove(this.closeButtonNode, "listInputCloseIcon-hover");
	},
