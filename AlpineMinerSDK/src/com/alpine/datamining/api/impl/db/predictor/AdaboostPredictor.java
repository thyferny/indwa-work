/**
 * ClassName AdaboostPredictor.java
 *
...
public class AdaboostPredictor extends AbstractDBModelPredictor{
	private static Logger logger= Logger.getLogger(AdaboostPredictor.class);
	private DataSet dataSet;

	protected AnalyzerOutPutDataBaseUpdate doPredict(
			DataBaseAnalyticSource dataBaseAnalyticSource,
			PredictorConfig predictorConfig) throws AnalysisException {
