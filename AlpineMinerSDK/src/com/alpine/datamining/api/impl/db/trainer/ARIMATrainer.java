...
import com.alpine.datamining.operator.timeseries.ARIMA;
...
public class ARIMATrainer extends AbstractDBModelTrainer {
	private static Logger logger= Logger.getLogger(ARIMATrainer.class);
	protected   Model train( AnalyticSource source )
		...
		try {
			...
			Operator learner = OperatorUtil.createOperator(ARIMA.class);
