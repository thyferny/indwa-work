/**
 * ClassName HadoopRocEvaluator.java
 *
...
public class HadoopRocEvaluator extends AbstractHadoopModelValidator{
	...
	public AnalyticOutPut doAnalysis(AnalyticSource source)
		...
		try {
			...
			for(EngineModel eModel:config.getTrainedModel()){
				...
				if(adpter!=null){
					resultList.add(adpter.generateROCData(eModel,source));
