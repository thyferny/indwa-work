...
//	  LogService.getInstance().logDebug("diag"+diag.toString());
//	  LogService.getInstance().logDebug("pivot"+pivot.toString());
//	  LogService.getInstance().logDebug("zeroz"+zero.toString());
      if (B.getRowDimension() != m) {
         throw new IllegalArgumentException("Matrix row dimensions must agree.");
      }
