 ...
 *
 */
public class TimeSeriesOperator extends LearnerOperator {
	...
	public static final List<String> parameterNames = Arrays.asList(new String[]{
			...
			OperatorParameter.NAME_Load_Data_Threshhold,
			
	});
	
	public TimeSeriesOperator() {
		super(parameterNames);
		addInputClass(OperatorInputTableInfo.class.getName());
		addOutputClass(EngineModel.MPDE_TYPE_TIMESERIES);
	}
	...
	public boolean isVaild(VariableModel variableModel) {
		...
		for(OperatorParameter para:paraList){
			...
			if(paraName.equals(OperatorParameter.NAME_IDColumn_lower)){
				...
				validateNull(invalidParameterList, paraName, paraValue);
				validateInteger(invalidParameterList, paraName, paraValue,0,false,10,false,variableModel);
			}else if(paraName.equals(OperatorParameter.NAME_Load_Data_Threshhold)){
				validateNull(invalidParameterList, paraName, paraValue);
