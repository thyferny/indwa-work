/**
 * ClassName CorrelationAnalysisOperator.java
 *
 ...
 *
 */
public class CorrelationAnalysisOperator extends AbstractOperator {
	
	public static final List<String> parameterNames = Arrays.asList(new String[]{
			OperatorParameter.NAME_columnNames
	});
	public CorrelationAnalysisOperator() {
	...
	public String getToolTipTypeName() {
		return LanguagePack.getMessage(LanguagePack.CORRELATION_OPERATOR,locale);
	}
