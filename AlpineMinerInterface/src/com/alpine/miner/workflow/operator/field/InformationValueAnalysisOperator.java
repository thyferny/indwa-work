/**
 * ClassName InformationValueOperator.java
 *
 ...
 *
 */
public class InformationValueAnalysisOperator extends AbstractOperator {
	public static final List<String> parameterNames = Arrays.asList(new String[]{
			OperatorParameter.NAME_dependentColumn,
			OperatorParameter.NAME_good,
			OperatorParameter.NAME_columnNames
  
	});

	public InformationValueAnalysisOperator() {
	...
	public String getToolTipTypeName() {
		return LanguagePack.getMessage(LanguagePack.INFORMATIONVALUE_OPERATOR,locale);
	}
	...
	public boolean isVaild(VariableModel variableModel) {
		...
		for(OperatorParameter para:paraList){
			...
			}else if(paraName.equals(OperatorParameter.NAME_good)){
				validateNull(invalidParameterList, paraName, paraValue);
