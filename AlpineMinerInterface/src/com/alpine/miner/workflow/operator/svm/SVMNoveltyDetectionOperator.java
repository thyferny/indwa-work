/**
 * ClassName SVMNoveltyDetectionOperator.java
 *
...
public class SVMNoveltyDetectionOperator extends LearnerOperator {
	...
	public SVMNoveltyDetectionOperator() {
		super(parameterNames);
		addInputClass(OperatorInputTableInfo.class.getName());
		addOutputClass(EngineModel.MPDE_TYPE_SVM_ND);
	}
	
	@Override
	public String getToolTipTypeName() {
		return LanguagePack.getMessage(LanguagePack.SVM_NOVELTY_DETECTION_OPERATOR,locale);
	}
