...
public class LogisticRegressionOperator extends LearnerOperator {
	...
	public LogisticRegressionOperator() {
		super(parameterNames);
		addInputClass(OperatorInputTableInfo.class.getName());
		addOutputClass(EngineModel.MPDE_TYPE_LOR);
	}
...
//						invalidParameterList.add(paraName);
	...
	public String getOperatorParameterDefaultValue(String paraName) {
		if(paraName.equals(OperatorParameter.NAME_max_generations)){
			...
			return "0.00000001";
		}else if (paraName.equals(OperatorParameter.NAME_isStepWise)){
