 ...
 * Aug 21, 2012
 */
public class PostgresCreatorImpl extends TableCreator {

	/**
	 * @param connInfo
	 */
	public PostgresCreatorImpl(DbConnection connInfo) {
		super(connInfo);
	}
	public PostgresCreatorImpl(String userName,String password,String url,String system,Locale locale,String useSSL){
