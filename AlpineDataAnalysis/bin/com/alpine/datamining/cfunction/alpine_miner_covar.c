...
PG_FUNCTION_INFO_V1(alpine_miner_covar_accum);
PG_FUNCTION_INFO_V1(alpine_miner_covar_combine);
PG_FUNCTION_INFO_V1(alpine_miner_covar_final);

Datum
alpine_miner_covar_accum(PG_FUNCTION_ARGS)
{
...
Datum
alpine_miner_covar_combine(PG_FUNCTION_ARGS)
{
...
Datum
alpine_miner_covar_final(PG_FUNCTION_ARGS){
		if (PG_ARGISNULL(0))
		PG_RETURN_NULL();
		ArrayType *state = PG_GETARG_ARRAYTYPE_P(0);
		 ArrayType * result;
