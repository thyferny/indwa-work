...
* ClassName ResidualDataGenaratorOracle.java
*
...
public class ResidualDataGenaratorOracle extends ResidualDataGenarator{
	public   StringBuffer getResidualString(String dependColumn,
		...
		sover.append(" as alpine_residual,SYS.DBMS_RANDOM.VALUE()   as alpinelinearrandom from " + schemaName + "." + tableName
				+ " " + sbWhere + " order by alpinelinearrandom  ) foo  where rownum<= ").append(maxRows).append(" ");
