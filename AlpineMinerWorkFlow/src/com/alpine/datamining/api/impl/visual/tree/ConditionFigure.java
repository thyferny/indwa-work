...
public class ConditionFigure extends ActivityFigure {

	public final static int NodeWidth = 100;
	public final static int NodeHeight = 46;
	...
	public void paintFigure(Graphics g) {
	    ...
	    g.drawImage(VisualUtility.getNotLeafImage(), r.x, r.y);
	    
	    if(getDisplayMessage() != null){
	    	g.setForegroundColor(ColorConstant.white);
