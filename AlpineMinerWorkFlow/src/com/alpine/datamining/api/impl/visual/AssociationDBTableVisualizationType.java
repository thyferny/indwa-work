...
public class AssociationDBTableVisualizationType extends TableVisualizationType {
    private static final Logger itsLogger=Logger.getLogger(AssociationDBTableVisualizationType.class);
    @Override
