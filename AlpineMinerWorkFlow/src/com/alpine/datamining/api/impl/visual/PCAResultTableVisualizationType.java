/**
 * ClassName PCAResultTableVisualizationType.java
 *
...
public class PCAResultTableVisualizationType extends
		DataOperationTableVisualizationType {
    private static final Logger itsLogger =Logger.getLogger(PCAResultTableVisualizationType.class);
    public VisualizationOutPut generateOutPut(AnalyticOutPut analyzerOutPut) {
		...
		if (analyzerOutPut instanceof AnalyzerOutPutPCA) {
			...
			result = outPut.getPCAQvalueTables();
		...
		output.setName(VisualLanguagePack.getMessage(
				VisualLanguagePack.PCA_VALUEOUTPUTTABLE, locale));
